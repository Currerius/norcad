...
@ 
Surface spline of \Sexpr{sapply( JSON$Endpoints , with , Label )[n.Surv]} incidence by empirical percentiles of \Sexpr{sapply( JSON$Predictors , with , Label )[n.P]} and \Sexpr{sapply( JSON$Modifiers , with , Label )[n.M]} estimated with a Generalized Additve Model.
\end{frame}
...
@ 
Surface spline of \Sexpr{sapply( JSON$Endpoints , with , Label )[n.Surv]} incidence by empirical percentiles of \Sexpr{sapply( JSON$Predictors , with , Label )[n.P]} and \Sexpr{sapply( JSON$Modifiers , with , Label )[n.M]} estimated with a Generalized Additve Model; coloured grids depict 95\% confidence levels.
